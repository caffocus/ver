...
import com.example.caffocus.databinding.ActivityResttimesoundBinding
import com.example.caffocus.databinding.ActivityWhitenoisesettingBinding

class resttimesound : AppCompatActivity() {
    private var mediaPlayer: MediaPlayer? = null
    private var currentVolume = 50
    lateinit var binding: ActivityResttimesoundBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_resttimesound)

        binding = ActivityResttimesoundBinding.inflate(layoutInflater)
